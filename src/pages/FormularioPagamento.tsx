        ...
        <section className="fintech-gradient py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Complete seus dados e garante acesso completo à nossa plataforma
            </p>
          </div>
        </section>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="basic">Escola Básica - R$ 299,00/mês</SelectItem>
                        <SelectItem value="premium">Escola Premium - R$ 599,00/mês</SelectItem>
                        <SelectItem value="enterprise">Rede de Ensino - Sob consulta</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between font-semibold text-lg">
                      <span>Total</span>
                      <span className="text-[#1A247E]">R$ 499,00</span>
                    </div>
                  </div>
